...
let acceptedFormats = ["jpg", "jpeg", "png", "bmp"]
...
function convert() {
    ...
    console.log(`"Current format: ${currentFormat} | Desired format: ${outputFormat}`)
    ...
    exec(command, function (error, stdout, stderr) {
        ...
        alert('Converted file can be found in the "Converted" folder!')
    })
}